...
description: Descubra cómo puede utilizar el Servicio de consultas de Adobe Experience Platform con herramientas de visualización de datos externas mediante un ejemplo de análisis de pérdida.
feature: Queries
role: Developer
level: Intermediate
jira: KT-10191

...
+ Asistente de IA {#ai-assistant}
   ...
   + [Agente de experimentación](/help/platform/ai-assistant/experimentation-agent-overview.md)
   + [Data Insights Agent](https://experienceleague.adobe.com/es/docs/customer-journey-analytics-learn/tutorials/data-insights-agent/introduction-to-the-data-insights-agent)
...
+ Distiller de datos y consultas {#queries}
   ...
   + [Generar conjuntos de datos a partir de resultados de consultas](https://experienceleague.adobe.com/es/docs/experience-platform/query/ui/create-datasets){target="_blank"}
   ...
   + [Conectar clientes al servicio de consultas](https://experienceleague.adobe.com/es/docs/experience-platform/query/clients/overview){target="_blank"}

...
+ Audiencias y segmentación {#audiences}
   ...
   + Tutoriales{#audience-tutorials}
      ...
      + [Interactúe con audiencias de su almacén de datos](https://experienceleague.adobe.com/en/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview){target="_blank"}
...
+ Ingesta de datos {#data-ingestion}
   ...
   + [Asignar un archivo CSV a XDM](https://experienceleague.adobe.com/en/docs/experience-platform/ingestion/tutorials/map-csv/existing-schema){target="_blank"}
...
+ Distiller de datos y consultas {#queries}
   ...
   + [Generar conjuntos de datos a partir de resultados de consultas](https://experienceleague.adobe.com/en/docs/experience-platform/query/ui/create-datasets){target="_blank"}
   ...
   + [Conectar clientes al servicio de consultas](https://experienceleague.adobe.com/en/docs/experience-platform/query/clients/overview){target="_blank"}

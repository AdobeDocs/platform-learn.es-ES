...
+ Control de datos {#data-governance}
   ...
   + [Clasificar datos mediante etiquetas de gobernanza](/help/platform/governance/classify-data-using-governance-labels.md)
...
+ Data Science Workspace {#data-science-workspace}
   ...
   + [Creación del esquema y el conjunto de datos del curso](data-science-workspace/create-the-course-schema-and-dataset.md)
   + [Carga de datos en cuadernos de JupyterLab](data-science-workspace/load-data-in-jupyterlab-notebooks.md)
   + [Consulta y descubrimiento de datos en cuadernos de JupyterLab](data-science-workspace/dsw-query-service.md)
   + [Análisis de datos exploratorio](data-science-workspace/eda.md)
   + [Información general sobre fórmulas, modelos y servicios](data-science-workspace/recipes-models-services-overview.md)
   + [Crear un modelo con la plantilla del generador de fórmulas](data-science-workspace/recipe-builder-template.md)
   + [Analizar el rendimiento del modelo](data-science-workspace/analyze-model-performance.md)
   + [Creación y publicación de un modelo entrenado (IU)](data-science-workspace/create-model-ui.md)
   + [Programar formación y puntuación automatizadas para un servicio](data-science-workspace/schedule-training-scoring.md)
   + [Enriquezca los perfiles de clientes en tiempo real con perspectivas de aprendizaje automático](data-science-workspace/dsw-profile-segmentation.md)
   + [Empaquetar archivos de origen en una fórmula](https://experienceleague.adobe.com/docs/experience-platform/data-science-workspace/models-recipes/package-source-files-recipe.html){target="_blank"}
   + [Importación de una fórmula empaquetada (IU)](https://experienceleague.adobe.com/docs/experience-platform/data-science-workspace/models-recipes/import-packaged-recipe-ui.html){target="_blank"}
...
+ Destinos {#destinations}
   ...
   + [Seminario web Activar datos en aplicaciones que no sean de Adobe](/help/platform/destinations/activate-data-to-non-adobe-applications.md)
...
+ Segmentos {#segments}
   ...
   + [Creación de segmentos basados en contenido](/help/platform/segments/create-content-based-segments.md)
   + [Creación de segmentos de conversión](/help/platform/segments/create-conversion-segments.md)
   + [Creación de segmentos a partir de segmentos existentes](/help/platform/segments/create-segments-from-existing-segments.md)
   + [Creación de segmentos secuenciales](/help/platform/segments/create-sequential-segments.md)
   + [Creación de segmentos dinámicos](/help/platform/segments/create-dynamic-segments.md)
   + [Creación de segmentos de varias entidades](/help/platform/segments/create-multi-entity-segments.md)
   + [Creación de segmentos con datos B2B](/help/platform/segments/create-segments-with-b2b-data.md)
   + [Demostración de la segmentación de streaming](/help/platform/segments/streaming-segmentation-demo.md)
   + [Evaluación de un segmento](https://experienceleague.adobe.com/docs/experience-platform/segmentation/tutorials/evaluate-a-segment.html){target="_blank"}
...
+ Integraciones de Experience Cloud {#experience-cloud}
   ...
   + [Organización de campañas con Marketo Engage](https://experienceleague.adobe.com/docs/platform-learn/tutorials/application-services/rtcdp/orchestrate-campaigns-with-marketo-engage.html)

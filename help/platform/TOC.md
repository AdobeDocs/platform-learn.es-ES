...
+ Introducción a Real-Time CDP {#rtcdp}
   + [Resumen general](rtcdp/understanding-the-real-time-customer-data-platform.md)
   + [Cómo usar Real-Time CDP](rtcdp/understanding-the-real-time-customer-data-platform-user-interface.md)
   + [Demostración de extremo a extremo](rtcdp/demo.md)
   + [Información general de B2B edition](rtcdp/b2b-overview.md)
   + [Organización de campañas con Marketo Engage](rtcdp/orchestrate-campaigns-with-marketo-engage.md)
+ [Introducción: arquitectos de datos e ingenieros de datos](https://experienceleague.adobe.com/es/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview){target="_blank"}
...
+ Administración {#admin}
   ...
   + [Añadir usuarios a la recopilación de datos](https://experienceleague.adobe.com/es/docs/platform-learn/data-collection/users-and-permissions)
...
+ Asistente de IA {#ai-assistant}
   ...
   + [Interfaz de Agent Orchestrator](/help/platform/ai-assistant/agent-orchestrator-ui.md)
   ...
   + [Agente de soporte del producto](/help/platform/ai-assistant/product-support-agent.md)
   ...
   + [Créditos de IA](/help/platform/ai-assistant/ai-credits.md)
   + [Información general de seguridad](/help/platform/ai-assistant/security-overview.md)
+ API {#api}
   + [Autenticar en las API de Experience Platform](/help/platform/api/platform-api-authentication.md)
   + [Generar un token de acceso](/help/platform/api/generate-an-access-token.md)
   + [Usar API](/help/platform/api/use-apis-with-postman.md)
+ Audiencias y segmentación {#audiences}
   + Generador de audiencias{#audience-builder}
      + [Introducción](audiences/audience-builder/introduction-to-audience-portal-and-composition.md)
      + [Cargar audiencias](audiences/audience-builder/upload-audiences.md)
      ...
      + [Demostración de la segmentación de streaming](/help/platform/audiences/audience-builder/streaming-segmentation-demo.md)
      + [Evaluar audiencias por lotes bajo demanda](/help/platform/audiences/audience-builder/evaluate-audiences-on-demand.md)
   + Composición de público federado {#fac}
      + [Información general](audiences/fac/overview-of-federated-audience-composition.md)
      + [Configuración de una conexión federada](audiences/fac/connect-and-configure-federated-audience-composition.md)
      + [Conectar con Oracle](audiences/fac/connect-to-oracle.md)
      + [Crear una audiencia federada](audiences/fac/create-a-federated-audience-composition.md)
      + [Suscribirse a alertas](audiences/fac/subscribe-to-alerts.md)
   + Coincidencia de segmento{#segment-match}
      + [Configuración de conexión de coincidencia de segmentos](/help/platform/audiences/segment-match/segment-match-connection-setup.md)
      + [Gobernanza de datos de coincidencia de segmentos](/help/platform/audiences/segment-match/segment-match-data-governance.md)
      + [Flujo de configuración de Coincidencia de segmentos](/help/platform/audiences/segment-match/segment-match-configuration-flow.md)
      + [Perspectivas previas al uso compartido de coincidencias de segmentos](/help/platform/audiences/segment-match/segment-match-pre-share-insights.md)
      + [Coincidencias de segmentos recibiendo datos](/help/platform/audiences/segment-match/segment-match-receiving-data.md)
   + Tutoriales{#audience-tutorials}
      + [Evaluar una regla de audiencia](https://experienceleague.adobe.com/es/docs/experience-platform/segmentation/tutorials/evaluate-a-segment){target="_blank"}
      + [Creación de un conjunto de datos para exportar datos](https://experienceleague.adobe.com/es/docs/experience-platform/segmentation/tutorials/create-dataset-export-segment){target="_blank"}
      + [Interactúe con las audiencias de su almacén de datos](https://experienceleague.adobe.com/es/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview){target="_blank"}
+ [Registros de auditoría](/help/platform/governance/audit-logs.md)
+ [Recopilación de datos](https://experienceleague.adobe.com/es/docs/platform-learn/data-collection/overview){target="_blank"}
+ Colaboración {#collaboration}
   + [Información general de Real-Time CDP Collaboration](collaboration/real-time-cdp-collaboration-overview.md)
   + [Introducción a Collaboration](collaboration/real-time-cdp-collaboration-intro.md)
   + [Información general de Real-Time CDP para profesionales de la agencia](collaboration/rtcdp-overview-for-agency-practitioners.md)
   + [Collaboration: Proceso y personas](collaboration/rtcdp-collaboration-process-and-people.md)
   ...
   + [Crear un proyecto](collaboration/create-a-project.md)
   + [Detectar superposiciones de audiencias](collaboration/discover-audience-overlaps-in-projects.md)
   + [Activación de audiencias en colaboradores](collaboration/activate-audiences-in-projects.md)
   + [Medición de Collaboration: configuración y creación de informes](collaboration/collaboration-measurement-setup-and-report-creation.md)
   + [De marca a marca](collaboration/brand-to-brand-collaboration.md)
   + [Invitar a socios a utilizar Collaboration](collaboration/rtcdp-collaboration-in-product-invitations.md)
...
+ Higiene de los datos {#data-hygiene}
   ...
   + [Caducar conjuntos de datos](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/data-lifecycle/expire-datasets)
   + [Caducidad de perfil y evento seudónimos (TTL)](/help/platform/data-hygiene/pseudonymous-profile-and-event-expiration.md)
   + [Eliminación de perfiles](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/profiles/delete-profiles)
   + [Actualización de un atributo de perfil](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/profiles/update-a-specific-attribute-with-upsert)
+ Ingesta de datos {#data-ingestion}
   ...
   + [Asignación de un archivo CSV a XDM](https://experienceleague.adobe.com/es/docs/experience-platform/ingestion/tutorials/map-csv/existing-schema){target="_blank"}
   + [Información general de fuentes](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/overview)
   + [Ingesta de datos desde Adobe Analytics](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics)
   + [Ingesta de datos desde Audience Manager](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/ingest-data-from-aam)
   + [Ingesta de datos desde el almacenamiento en la nube](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage)
   + [Ingesta de datos desde CRM](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/ingest-data-from-crm)
   + [Ingesta de datos desde bases de datos](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/ingest-data-from-databases)
   + [Resumen de ingesta de streaming](/help/platform/data-ingestion/understanding-streaming-ingestion.md)
   + [Transmitir datos con API HTTP](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api)
   + [Transmisión de datos mediante conectores de Source](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector)
   + [Tutoriales de Web SDK](https://experienceleague.adobe.com/es/docs/platform-learn/data-collection/web-sdk/overview){target="_blank"}
   + [Tutoriales de Mobile SDK](https://experienceleague.adobe.com/es/docs/platform-learn/data-collection/mobile-sdk/overview){target="_blank"}
...
+ Destinos {#destinations}
   ...
   + [Configuración del destino de Marketo Engage](/help/platform/destinations/configure-the-marketo-destination.md)
   ...
   + Data Warehouse {#data-warehouse}
      + [Enviar datos de audiencia a Snowflake por lotes para compartir datos](/help/platform/destinations/data-warehouse/send-audience-data-snowflake-batch.md)
...
+ Identidades {#identities}
   ...
   + Reglas de vinculación de gráficos de identidad {#graph-linking-rules}
      ...
      + [Configuración de identidad](/help/platform/identities/identity-graph-linking-rules/identity-settings.md)
...
+ Monitorización {#monitoring}
   ...
   + [Administración de capacidad de streaming](monitoring/streaming-management.md)
   + [Integración con Slack](monitoring/monitor-events-in-slack.md)
...
+ Perfiles {#profiles}
   ...
   + [Personalizar detalles de vista de perfil](https://experienceleague.adobe.com/es/docs/experience-platform/profile/ui/profile-customization){target="_blank"}
...
+ Distiller de datos y consultas {#queries}
   ...
   + [Validar datos](/help/platform/queries/explore-data.md)
   + [Derivar datos](/help/platform/queries/prepare-data.md)
   ...
   + [Conectar Tableau](/help/platform/queries/psql-client-tableau.md)
   + [Analizar y visualizar datos en Tableau](/help/platform/queries/analyze-and-visualize.md)
...
+ Esquemas {#schemas}
   ...
   + [Creación de un esquema ad hoc](https://experienceleague.adobe.com/es/docs/experience-platform/xdm/tutorials/ad-hoc){target="_blank"}
+ Fuentes {#sources}
...
+ Manuales de tácticas de casos de uso {#use-case-playbooks}
   ...
   + [Configuración de una zona protegida del manual de tácticas](/help/platform/use-case-playbooks/configure-a-playbook-sandbox.md)
...
+ Integraciones de Experience Cloud {#experience-cloud}
   + [Analytics](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics)
   + [Audience Manager](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/sources/ingest-data-from-aam)
   + [Commerce](/help/platform/experience-cloud/business-value-of-platform-and-commerce.md)
   + [Marketo Engage](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/rtcdp/orchestrate-campaigns-with-marketo-engage)
   + [Target](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/destinations/target/next-hit-personalization)

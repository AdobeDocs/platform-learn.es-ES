...
Como anunciante, aprenda a establecer una conexión con un editor para colaborar con él. Para obtener documentación detallada, consulte [establecimiento de conexiones](https://experienceleague.adobe.com/en/docs/real-time-cdp-collaboration/using/connect/establishing-connections){target="_blank"}.

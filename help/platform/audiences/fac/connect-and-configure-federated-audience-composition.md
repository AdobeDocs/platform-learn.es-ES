...
Aprenda a conectarse al almacén de datos y a configurar esa conexión para la Composición de audiencias federada. Para obtener más información, visite [Documentación de composición de audiencias federadas](https://experienceleague.adobe.com/es/docs/federated-audience-composition/using/home){target="_blank"}.

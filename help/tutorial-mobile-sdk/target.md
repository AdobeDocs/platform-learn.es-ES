...
* Acceso a Adobe Target con permisos, funciones, espacios de trabajo y propiedades correctamente configurados como se describe [aquí](https://experienceleague.adobe.com/docs/target/using/administer/manage-users/enterprise/property-channel.html?lang=es).
...
1. Si es cliente de Target Premium y desea usar tokens de propiedad, escriba el valor de Target **[!UICONTROL Token de propiedad]** que desee usar para esta integración. Los usuarios de Target Standard pueden omitir este paso.
...
1. Seleccione **[!UICONTROL Guardar]**.
1. Seleccione **[!UICONTROL Validar configuración]** en el carril izquierdo. Tanto la configuración del flujo de datos como la configuración del SDK se validan en la aplicación.
...
1. En el cuadro de diálogo **[!UICONTROL Crear actividad de prueba A/B]**, seleccione **[!UICONTROL Móvil]** como **[!UICONTROL Tipo]**, seleccione un área de trabajo de la lista **[!UICONTROL Elegir Workspace]** y seleccione su propiedad de la lista **[!UICONTROL Elegir propiedad]** si es cliente de Target Premium y especificó un token de propiedad en el conjunto de datos.
...
1. En la pantalla **[!UICONTROL Actividad sin título]**, en el paso **[!UICONTROL Experiencias]**:
   ...
   1. Seleccione ![Corchete hacia abajo](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ChevronDown_18_N.svg) junto a **[!UICONTROL Contenido predeterminado]** y seleccione **[!UICONTROL Crear oferta JSON]** en el menú contextual.
   1. Copie el siguiente JSON en **[!UICONTROL Escriba un objeto JSON válido]**.
   ...
   1. Seleccione **[!UICONTROL + Agregar experiencia]**.
...
1. En el paso **[!DNL Targeting]**, revise la configuración de la prueba A/B. De forma predeterminada, ambas ofertas se asignan de forma equitativa entre todos los visitantes. Haga clic en **[!UICONTROL Siguiente]** para continuar.
...
1. En el paso **[!UICONTROL Objetivos y configuración]**:
   ...
   1. Seleccione **[!UICONTROL Guardar y cerrar]**.
      ...
      ![Configuración de metas](assets/target-goals.png)
...
1. Vaya a la ficha **[!UICONTROL Personalización]**.
...
1. Puede explorar las pestañas **[!UICONTROL Simular]** y **[!UICONTROL Lista de eventos]** para obtener más funcionalidad al comprobar la configuración de ofertas de Target.

...
* Acceso a Journey Optimizer y [permisos suficientes para notificaciones push](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/push/push-config/push-configuration). Además, necesita permisos suficientes para las siguientes funciones de Journey Optimizer.
...
1. En la pantalla **[!UICONTROL Campaign - *AAAA-MM-DD HH:MM:SS UTC+XX:XX*]**:
   ...
   1. En la pantalla de definición de campaña principal, seleccione la pestaña **[!UICONTROL Content]**.
      ...
      1. En la ficha **[!UICONTROL Contenido]**.
         1. Escriba `https://newluma.enablementadobe.com/images/logo.png` para la **[!UICONTROL URL multimedia]**.

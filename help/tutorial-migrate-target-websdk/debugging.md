---
title: Depurar | Migración de Target de at.js 2.x a SDK web
...
![Cómo ver los seguimientos de Target con el Adobe Experience Platform Debugger](assets/target-trace-debugger.png){zoomable="yes"}
...
![Elementos específicos de destino de la carga útil del SDK web de Platform](assets/target-payload.png){zoomable="yes"}
...
![Elementos específicos de destino del cuerpo de respuesta del SDK web de Platform](assets/target-response.png){zoomable="yes"}

...
* Habilite Edge Trace para ver las solicitudes del lado del servidor enviadas por el Edge Network de Platform
...
1. Seleccione el botón **[!UICONTROL Iniciar sesión]** e inicie sesión en Adobe Experience Cloud con su ID de Adobe.
1. Ahora, ve a **[!UICONTROL Etiquetas de Experience Platform]** en el panel de navegación izquierdo
...
1. Ahora, ve a **[!UICONTROL SDK web de Experience Platform]** en la navegación izquierda para ver las **[!UICONTROL solicitudes de red]**
...
1. Abra la sección **[!UICONTROL SDK web de Experience Platform]** en el panel de navegación izquierdo
...
Como aprendió en la lección [Configuración de un conjunto de datos](configure-datastream.md), el SDK web de Platform envía primero datos de su propiedad digital al Edge Network de Platform. A continuación, Platform Edge Network realiza solicitudes adicionales del lado del servidor a los servicios correspondientes habilitados en el conjunto de datos. Puede validar las solicitudes del lado del servidor realizadas por Platform Edge Network mediante Edge Trace en Debugger.

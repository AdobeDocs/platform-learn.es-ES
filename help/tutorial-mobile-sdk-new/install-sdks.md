...
En Xcode en el origen de **[!UICONTROL AppDelegate]** y **[!UICONTROL MobileSDK]**, agregue las siguientes importaciones.
...
1. Añada el siguiente código resaltado a `application(_, didFinishLaunchingWithOptions)` función.

...
description: Descubra cómo validar las integraciones de públicos, A4T y Atributos del cliente en su implementación de Adobe Experience Cloud. Esta lección forma parte del tutorial Implementación de Experience Cloud en sitios web.
...
1. Explicar los casos de uso básicos de las integraciones de Compartir públicos, Analytics para Target (A4T) y Atributos del cliente.
...
>
>* Examinar todos los requisitos de las [integraciones de servicios principales](https://experienceleague.adobe.com/es/docs/core-services/interface/services/getting-started).
>* Revise todos los requisitos de la [integración de Analytics para Target](https://experienceleague.adobe.com/es/docs/target/using/integrate/a4t/before-implement).
...
1. Implemente otras soluciones en las que desee recibir o crear públicos, como Target y Analytics

### Validar la integración de públicos

La mejor manera de validar la integración de públicos es crear un público, compartirlo en otra solución y luego usarlo por completo en la otra solución (por ejemplo, confirmar que un visitante apto para un segmento de AAM puede cumplir los requisitos para una actividad de Target dirigida a ese segmento). Sin embargo, eso no entra dentro del ámbito de este tutorial.
...
1. Haga clic en **[!UICONTROL Borrar todas las solicitudes]** solo para limpiar los campos
...
1. Escriba `test@test.com` como nombre de usuario.

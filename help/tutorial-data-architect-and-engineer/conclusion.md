...
* Configure el acceso a la API de Platform en Developer Console y utilice las colecciones Postman de Experience Platform, que **Arquitectos de datos** y **Ingenieros de datos** encontrarán útiles
...
* Transmita datos mediante Adobe Experience Platform Web SDK, que **ingenieros de datos** suelen necesitar para coordinar con sus desarrolladores web

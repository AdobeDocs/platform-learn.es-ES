...
Otras formas comunes de transmitir datos a Platform
...
* Debemos implementar Web SDK en el sitio web de Luma para enviar datos sobre la actividad de los visitantes desde el sitio web a la red de Experience Platform Edge. Haremos una implementación sencilla mediante etiquetas (anteriormente Launch)

* Debemos configurar una secuencia de datos, que indique a la red de Edge dónde reenviar los datos. Lo configuraremos para enviar los datos al conjunto de datos `Luma Web Events` en nuestra zona protegida de Platform.

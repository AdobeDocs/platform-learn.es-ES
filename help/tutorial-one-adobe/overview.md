...
- Flujo de trabajo de Adobe Workfront, Adobe Workfront Planning y Adobe Workfront Fusion
...
- Cuando complete el módulo [Automatización del flujo de trabajo de Creative con Workfront Fusion](./modules/creation-production/module1.2/automation.md){target="_blank"}, estará listo para realizar y aprobar el examen **Adobe Qualified** **AD2-E902**:
...
[1.2 Administración del flujo de trabajo con Adobe Workfront Workflow](./modules/workflow-planning/module1.2/workfront.md){target="_blank"}
...
En este módulo, utilizará Adobe Workfront Fusion para automatizar y escalar los flujos de trabajo de creación de contenido.
...
[1.4 Adobe Express y Adobe Experience Cloud](./modules/creation-production/module1.4/express.md){target="_blank"}

En este módulo, utilizará Adobe Express para crear imágenes y vídeos, y compartirá esos recursos con el ecosistema de Adobe Experience Cloud en general.

[1.5 Optimice su flujo de trabajo con Frame.io](./modules/creation-production/module1.5/frameio.md){target="_blank"}
...
En este módulo, configurará el programa Adobe Experience Manager Cloud Service, el sitio y el repositorio de Assets.
...
En este módulo, explorará Adobe Experience Manager Forms con Edge Delivery Services.
...
En este módulo, creará su instancia de Adobe Commerce as a Cloud Service. Conectará la instancia de Commerce a AEM Sites CS Storefront y al entorno de AEM Assets CS.
...
[3.3 Adobe Journey Optimizer: mensajes push y en la aplicación](./modules/delivery-activation/ajo-b2c/ajob2c-3/ajopushinapp.md)

En este módulo, utilizará Adobe Journey Optimizer para configurar las notificaciones push y los mensajes en la aplicación.
...
[3.6 Adobe Journey Optimizer: Administración de contenido](./modules/delivery-activation/ajo-b2c/ajob2c-6/ajocontent.md)

En este módulo, aprenderá a configurar y utilizar tarjetas de contenido y páginas de destino en Adobe Journey Optimizer y profundizará en la integración entre Adobe Journey Optimizer y GenStudio for Performance Marketing.

[3.7 Adobe Journey Optimizer: Toma de decisiones](./modules/delivery-activation/ajo-b2c/ajob2c-7/ajo-decisioning.md)

En este módulo, aprenderá a configurar y utilizar Experiencias de toma de decisiones y basadas en código en Adobe Journey Optimizer.

[3.8 Adobe Journey Optimizer: Campañas](./modules/delivery-activation/ajo-b2c/ajob2c-8/ajocampaigns.md)

En este módulo, aprenderá a configurar y utilizar campañas en Adobe Journey Optimizer.

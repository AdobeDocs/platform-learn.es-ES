...
Entonces debería ver algo similar a esto. Escriba el siguiente comando y haga clic en el botón **Enviar**.
...
Ir a [1.1.5 Adobe Marketing Agent para Claude](./ex5.md){target="_blank"}

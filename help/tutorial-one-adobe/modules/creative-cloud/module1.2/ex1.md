...
# Introducción a Workfront Fusion
...
## Configuración de la autenticación de Adobe I/O
...
1. Cambie el nombre del segundo objeto a **Autenticar en el Adobe I/O**. Seleccione **Aceptar**.

...
## 2.1.5.1 Aplicar estilo al bloque
...
![Bloquear](./images/blockadv10.png)

Entonces debería ver esto. Haga clic en **Origen push**.

![Bloquear](./images/blockadv11.png)
...
![Bloquear](./images/blockadv12.png)
...
![Bloquear](./images/blockadv13.png)

## 2.1.5.2 Añadir lógica y cargar datos desde un extremo externo

Para este ejercicio, va a realizar una configuración &quot;sin procesar&quot; de SDK web de Adobe y va a solicitar la siguiente mejor oferta a Offer decisioning de Adobe Journey Optimizer.
...
La biblioteca **alloy.js** es la biblioteca detrás de Web SDK que permite enviar solicitudes desde un sitio web al Edge Network de Adobe y, desde allí, a aplicaciones como Adobe Experience Platform, Adobe Analytics, Adobe Target y más.
...
![Bloquear](./images/blockadv15.png)

Ahora debería tener esto.

![Bloquear](./images/blockadv14.png)
...
Este bloque de código se utiliza para recuperar el valor del ID del Experience Cloud (ECID). El ECID es el identificador de dispositivo único del explorador.
...
![Bloquear](./images/blockadv16.png)
...
![Bloquear](./images/blockadv17.png)
...
En la solicitud, se especifican 2 **Ámbitos de decisión** que solicitarán al Offer decisioning de Adobe Journey Optimizer que proporcione una decisión sobre qué oferta debe ver este ECID.
...
![Bloquear](./images/blockadv18.png)

A continuación, haga clic en **Origen push**.

![Bloquear](./images/blockadv19.png)

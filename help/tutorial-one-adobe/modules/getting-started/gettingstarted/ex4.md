...
Haga clic en **Seleccionar** en la propiedad de recopilación de datos creada en el paso anterior, que se llama `--aepUserLdap-- - Demo System (DD/MM/YYYY) (web)`. Haga clic en **Guardar**.

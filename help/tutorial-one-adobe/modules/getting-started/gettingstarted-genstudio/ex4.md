...
>[!IMPORTANT]
>
>Si no eres empleado de Adobe, sigue las instrucciones para [instalar Postman](./ex3.md){target="_blank"}. Las siguientes instrucciones están destinadas únicamente a empleados de Adobe.
...
Haga clic en la versión correcta para su sistema operativo.
...
Ir a [Aplicaciones para instalar](./ex5.md){target="_blank"}

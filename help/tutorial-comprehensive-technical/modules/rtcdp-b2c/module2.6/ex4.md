...
GET Haga clic en la primera solicitud, **Conectores Kafka Connect disponibles** para abrirlo de nuevo y haga clic de nuevo en el botón azul **Enviar**. ahora verá que existe un conector Kafka Connect.

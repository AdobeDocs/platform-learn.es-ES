...
Asigne un nombre a la clave de directiva de la siguiente manera: **Kinesis_PutRecord** y haga clic en **Crear directiva**.
...
- Seleccione **Tipo de acción**: **Enviar datos a la secuencia de datos de Kinesis**
- Nombre: **AWS - Enviar datos al flujo de datos de Kinesis**
...
>[!IMPORTANT]
>
>Una vez que la configuración funcione según lo esperado, no olvide apagar el flujo de datos de AWS Kinesis y la chimenea de datos para evitar que se le cobre.

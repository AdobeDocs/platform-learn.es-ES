...
Para visualizar las lecciones aprendidas en este tutorial y hacer posible que pruebe la configuración en un entorno seguro, este tutorial utiliza las herramientas Siguiente del sistema de demostración de Adobe. Para aprovechar al máximo este tutorial, la instancia de Adobe Experience Platform debe configurarse para integrarse con Demo System Next.
...
En el menú desplegable **Entorno**, seleccione la instancia de Adobe Experience Platform y la zona protegida.
